...
public:
	...
	vertex() : 
		_myVertex(0.0, 0.0, 0.0), _vertexNormal(0.0, 0.0, 0.0), _texCoor(0,0,0),
	...
	vertex(float x1, float y1, float z1) : 
		_myVertex(x1, y1, z1), _vertexNormal(0.0, 0.0, 0.0), _texCoor(0,0,0),
	...
	vertex(float x1, float y1, float z1, float tx, float ty, float tz) : 
		_myVertex(x1, y1, z1), _vertexNormal(0.0, 0.0, 0.0), _texCoor(tx,ty,tz),
		_bActive(true), _cost(0), _minCostNeighbor(-1),
		_index(-1), _QTriArea(0)
	{
		initQuadric();
	...
	vertex(float av[3]): 
		_myVertex(av), _vertexNormal(0.0, 0.0, 0.0), _texCoor(0,0,0),
		_bActive(true), _cost(0), _minCostNeighbor(-1),
		_index(-1), _QTriArea(0)
	{
		initQuadric();
	...
	vertex(float av[3], float vn[3]): 
		_myVertex(av), _vertexNormal(vn), _texCoor(0,0,0),
		_bActive(true),_cost(0), _minCostNeighbor(-1),
		_index(-1), _QTriArea(0)
	{
		initQuadric();
	...
	// copy ctor
	vertex(const vertex& v) : _myVertex(v._myVertex), _vertexNormal(v._vertexNormal), _texCoor(v._texCoor),
...
//	operator>>(istream& is, vertex& vi);
	...
	const float* getArrayVertTexCoors() const {
		_v[0]=_texCoor.x;
		_v[1]=_texCoor.y;
		_v[2]=_texCoor.z;
		return _v;}
