...
const float* triangle::getVert1TexCoor(){ return (_mesh->getVertex(_vert1)).getArrayVertTexCoors();}
const float* triangle::getVert2TexCoor(){ return (_mesh->getVertex(_vert2)).getArrayVertTexCoors();}
const float* triangle::getVert3TexCoor(){ return (_mesh->getVertex(_vert3)).getArrayVertTexCoors();}
