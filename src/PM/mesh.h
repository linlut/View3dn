...
public:
	...
	Mesh(const float pVertex[][3], const int nv, const int pTri[][3], const int ntri);
	Mesh(const float pVertex[][3], const float pTexCoor[][3], const int nv, const int pTri[][3], const int ntri);
	~Mesh();
