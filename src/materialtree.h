...
#ifndef __CMaterialTree_H__
#define __CMaterialTree_H__
...
typedef void SET_OBJECT_MATERIAL_FUNC_T(const char *);
...
public:
    ...
    CMaterialTree(const QString& appPathDir, CSceneNode *pActiveNode, QWidget *parent=0, const char *name=0);
...
public:
	...
	QDomNode* searchMaterialByID(const QString &id)
	{
...
public slots:
	...
	{
		this->setActiveSceneNode(p);
	}

	void pickingCursorChanged(QCursor *)
	{
		//this->setCursor(*qcur);
	}
