    ...
    void setSpinningQuaternion(const Quaternion& spinningQuaternion) 
	  {
		  ...
		  //spinningQuaternion.getAxisAngle (axis, angle);
		  //spinningQuaternion_ = Quaternion(axis, angle*0.05); 
		  spinningQuaternion_ = spinningQuaternion; //Quaternion(axis, angle*0.05); 
	  }
