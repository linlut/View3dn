...
int tri_tri_overlap_test_3d(CDFloat p1[3], CDFloat q1[3], CDFloat r1[3], 

			    CDFloat p2[3], CDFloat q2[3], CDFloat r2[3])
{
  CDFloat dp1, dq1, dr1, dp2, dq2, dr2;
  CDFloat v1[3], v2[3];
  CDFloat N1[3], N2[3]; 
...
int coplanar_tri_tri3d(CDFloat p1[3], CDFloat q1[3], CDFloat r1[3],
		       CDFloat p2[3], CDFloat q2[3], CDFloat r2[3],
		       CDFloat normal_1[3], CDFloat normal_2[3]){
  
  CDFloat P1[2],Q1[2],R1[2];
  CDFloat P2[2],Q2[2],R2[2];
...
int tri_tri_intersection_test_3d(CDFloat p1[3], CDFloat q1[3], CDFloat r1[3], 
				 CDFloat p2[3], CDFloat q2[3], CDFloat r2[3],
				 int * coplanar, 
				 CDFloat source[3], CDFloat target[3] )
				 
{
  CDFloat dp1, dq1, dr1, dp2, dq2, dr2;
  CDFloat v1[3], v2[3], v[3];
  CDFloat N1[3], N2[3], N[3];
  CDFloat alpha;
...
int ccw_tri_tri_intersection_2d(CDFloat p1[2], CDFloat q1[2], CDFloat r1[2], 
				CDFloat p2[2], CDFloat q2[2], CDFloat r2[2]) {
...
int tri_tri_overlap_test_2d(CDFloat p1[2], CDFloat q1[2], CDFloat r1[2], 
			    CDFloat p2[2], CDFloat q2[2], CDFloat r2[2]) {
