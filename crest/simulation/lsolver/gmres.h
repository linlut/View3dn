...
inline int gmres( int m, int N, const Matrix &A, const double *b, double *x, double eps );


template< class Matrix >
inline int gmres( int m, int N, const Matrix &A, const double *b, double *x, double eps, bool detailed );
