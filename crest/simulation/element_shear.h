...
{
	const double ZERO_RODLENGTH = 1e-60;
    const Vector3d DIJ =  TXI - XI;
...
public:
	...
	inline void init(const CMeMaterialProperty &mtl, const Vector3d& p0, const Vector3d& p1, const double3x3& rot, const double &vol)
	{
		_init(p0, p1, &rot, vol);
	}
