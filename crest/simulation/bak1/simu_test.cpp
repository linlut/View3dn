...
//extern bool loadQuadMeshFile(const char *fname, Vector3d*& pVertex, int &nv, Vector4i*& pQuad, int &nquad, Vector2f *&texcord);
//extern bool loadTriangleMeshFile(const char *fname, Vector3d*& pVertex, int &nv, Vector3i*& pQuad, int &nquad, Vector2f *&texcord);
/*
...
void test_mainBEAMSHEAR(void) //BEAMShear
{
	typedef CSimuThinshell T;
	CMeMaterialProperty mtl;
	mtl.setYoung(2.00e4);
