//FILE: truss_element.h

#ifndef _INC_TRUSS_ELMT_ZNH_
#define _INC_TRUSS_ELMT_ZNH_
...
public:
	...
	CTrussElement(const int vertexid[2], const Vector3d& p0, const Vector3d& p1, const double &K, const double &Kd=0)
	{
