...
#ifndef _CIA3D_INC_RIGIDTYPES_H
#define _CIA3D_INC_RIGIDTYPES_H

#include <vector>
#include <iostream>
#include <crest/base/vec.h>
#include <crest/base/mat.h>
...
template <>
inline StdRigidTypes<3, double>::Deriv inertiaForce<
	StdRigidTypes<3, double>::Coord,
	StdRigidTypes<3, double>::Deriv,
	BaseContext::Vec3,
	StdRigidMass<3, double>,
	BaseContext::SpatialVector
>
(
