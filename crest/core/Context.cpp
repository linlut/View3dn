...
{
    //setPositionInWorld(BaseContext::getPositionInWorld());
    setGravityInWorld(BaseContext::getLocalGravity());
    //setVelocityInWorld(BaseContext::getVelocityInWorld());
    //setVelocityBasedLinearAccelerationInWorld(BaseContext::getVelocityBasedLinearAccelerationInWorld());
    setDt(BaseContext::getDt());
    setTime(BaseContext::getTime());
    setAnimate(BaseContext::getAnimate());
    setShowCollisionModels(BaseContext::getShowCollisionModels());
    setShowBoundingCollisionModels(BaseContext::getShowBoundingCollisionModels());
    setShowBehaviorModels(BaseContext::getShowBehaviorModels());
    setShowVisualModels(BaseContext::getShowVisualModels());
    setShowMappings(BaseContext::getShowMappings());
    setShowMechanicalMappings(BaseContext::getShowMechanicalMappings());
    setShowForceFields(BaseContext::getShowForceFields());
    setShowInteractionForceFields(BaseContext::getShowInteractionForceFields());
    setShowWireFrame(BaseContext::getShowWireFrame());
    setShowNormals(BaseContext::getShowNormals());
    setMultiThreadSimulation(BaseContext::getMultiThreadSimulation());
}

//BaseContext* Context::getDefault()
//{
...
const Vec3& Context::getVelocityBasedLinearAccelerationInWorld() const
{
...
/// Gravity vector in local coordinates
Vec3 Context::getLocalGravity() const
{
...
const Vec3& Context::getGravityInWorld() const
{
